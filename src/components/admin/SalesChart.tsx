...
export default function SalesChart({ onToast }: { onToast?: (message: string) => void }) {
    ...
    if (loading) {
        return (
            <div className="bg-white dark:bg-dark-soft rounded-[20px] border border-border/40 p-6 animate-pulse shadow-sm transition-colors duration-300">
    ...
    return (
        <div className="bg-white dark:bg-[#0A0A0A] rounded-2xl border border-border/40 p-6 shadow-sm transition-colors duration-300">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
                ...
                {/* Tabs */}
                <div className="flex p-1 bg-gray-100 dark:bg-black/20 rounded-xl max-w-fit border border-border/40">
